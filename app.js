...
document.getElementById("fontOpenSans").addEventListener("click", function(){
...
document.getElementById("fontSizeSmaller").addEventListener("click", function(){
...
document.getElementById("fontSizeLarger").addEventListener("click", function(){
